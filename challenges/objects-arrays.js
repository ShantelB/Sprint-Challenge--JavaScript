...
const unisWithUni = ["Universidad Católica de Ávila", "Universitat Rovira I Virgili Tarragona", "Coastal Carolina University", "Salem University", "International Medical & Technological University"];
...
*/
const displayNames = zooAnimals.forEach(function(x, y){
  `${x.animal_name}, ${y.scientific_name}`;
});
...
*/
const populationTotal = zooAnimals.reduce(function(amount, size){
  return amount + size.population;
}, 0);
